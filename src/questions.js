// The first answer is the correct answer in the below raw js but that is only for determining whether user picked the correct answer or not in our web app logic
// But when we display the answers to the user we'll shuffle them
export default [
  {
    id: 'q1',
